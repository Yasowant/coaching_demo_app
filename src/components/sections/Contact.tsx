      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Have questions or ready to start your educational journey? Reach out to our team today.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mt-1">123 Education St, Learning City, 12345</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mt-1">contact@educoach.com</p>
                    <p className="text-muted-foreground">support@educoach.com</p>
                  </div>
                </div>
                ...
                <div className="flex space-x-3">
                  {["facebook", "twitter", "instagram", "linkedin"].map((social) => (
                    <a
                      key={social}
                      href="#"
                      className="bg-accent/50 hover:bg-primary hover:text-primary-foreground w-10 h-10 rounded-full flex items-center justify-center transition-colors"
                      aria-label={social}
                    >
                      <svg
                        className="w-5 h-5"
          ...
          <div>
            <div className="bg-card rounded-2xl p-8 border border-border shadow-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-gradient-to-r from-coach-purple to-coach-blue hover:opacity-90"
                >
                  Send Message
                </Button>
              </form>
